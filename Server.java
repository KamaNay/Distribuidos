...
public class Server extends Thread {
        ...
        for (Job job : jobs) {
            for (ExperienceJ experience : experiences) {
                for (JobSet jobset : jobsets) {
                    if (job.getSkill().equals(skillName) && experience.getId_company() == id
                            && job.getId() == experience.getId_skill() && jobset.getSkill().equals(skillName)) {
    ...
    private void handleDeleteJ(JsonObject requestJson, PrintWriter out) throws IOException {
        ...
        String getId = "SELECT * FROM jobs WHERE skill = ?";
        ...
        String deleteJ = "DELETE FROM jobs WHERE skill = ?";
        ...
        String deleteJS = "DELETE FROM jobset WHERE skill = ?";
