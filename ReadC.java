        ...
        try {
            ...
            if (responseJson.get("status").getAsString().equals("SUCCESS")) {
                ...
                if (dataObject != null) {
                    ...
                    JsonElement industryElement = dataObject.get("industry");
                    ...
                    if (industryElement != null) {
                        accountInfo.append("Empresa: ").append(industryElement.getAsString()).append("\n");
                    }
                    if (descriptionElement != null) {
                        accountInfo.append("Descrição: ").append(descriptionElement.getAsString()).append("\n");
                    }
                    if (idElement != null) {
